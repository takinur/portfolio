<template>
    ...
    <div class="wrapper pb-40">
        ...
        <section id="tools" class="pb-24 bg-gray-200 dark:bg-gray-800">
            <div class="container px-6 py-10 mx-auto md:mt-1 w-4/5 pb-9">
                ...
                >
                    ...
                    <div class="py-2">
                        <div
                            class="bg-cover w-28 md:mt-3 mx-auto grayscale dark:grayscale-0"
                        >
                            <img
                                v-bind:src="
                                    '/images/icons/' + 'chrome-8bit.svg'
                                "
                                alt=""
                            />
                        </div>
                        <h1
                            class="mt-2 md:mt-1 text-xl md:text-2xl text-center font-semibold text-gray-900 capitalize dark:text-white"
                        >
                            Chrome
                        </h1>
                        <p
        ...
        <!-- TOOls Section-->
        <section id="other" class="pb-24 bg-gray-100 dark:bg-gray-900">
            <div class="container px-6 py-10 mx-auto md:mt-1 w-4/5 pb-9">
                <h1 class="text-dark text-3xl text-center dark:text-zinc-200">
                    LAST BUT NOT LEAST
                </h1>
