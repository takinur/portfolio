        ...
        <div class="mobile-navbar z-[999]">
            <transition name="slide-fade">
                ...
                >
                    ...
                    <ul class="divide-y">
                        <li>
                            <a  @click.prevent="scrollToElement('intro')"
                                href="#intro"
                        ...
                        <li>
                            <a @click.prevent="scrollToElement('projects')"
                                href="#projects"
                        ...
                        <li>
                            <a  @click.prevent="scrollToElement('frameworks')"
                                href="#frameworks"
                                class="my-4 inline-block hover:text-orange-500 dark:text-white"
                                >Frameworks</a
                            >
                        ...
                        <li>
                            <a @click.prevent="scrollToElement('tools')"
                                href="#tools"
                                class="my-4 inline-block hover:text-orange-500 dark:text-white"
                                >Tools</a
                            >
                        ...
                        <li>
                            <a  @click.prevent="scrollToElement('other')"
                                href="#other"
                                class="my-4 inline-block hover:text-orange-500 dark:text-white"
                                >Other</a
                            >
